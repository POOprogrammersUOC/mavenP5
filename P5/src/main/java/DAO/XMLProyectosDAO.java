...
public class XMLProyectosDAO implements IProyectosDAO {
	...
	public XMLProyectosDAO() throws JAXBException { // creamos el constructor para que cada vez que se llame a la
													// función se ejecute
	...
	public Proyectos listaProyectos() throws JAXBException {
		 ...
		 * proyectosunm.getSublineaDeAccion()); System.out.println("Voluntarios: " +
		 * proyectosunm.getVoluntariosAsignados());
		 * 
		 * }
		 */
		return null;
